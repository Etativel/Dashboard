...
<div class="card-header">
      ...
      <table class="table">
        <thead>
            ...
            <br>
            <div>        <a href="{{ url('admin/disasterlocation/create') }}" class="btn btn-success btn-sm" title="Add New Disaster Location">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="text-center">
                    ...
                    <a href="{{ url('admin/disasterlocation/'.$disasterlocation->id)}}" title="View Disaster">

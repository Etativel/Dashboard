...
<div class="card-header">
  ...
  <table class="table">
    <thead>
        ...
        <br>
        <div>        <a href="{{ url('admin/disasterimage/create') }}" class="btn btn-success btn-sm" title="Add New Disaster Image">
        ...
        <tr>
            ...
            <td class="text-center">
                ...
                <form action="{{ route('disasterimage.destroy', $disasterimage->id)}}"  method="post" style="display: inline-block">
                    @csrf
                    @method('DELETE')
                    <button class="btn btn-danger btn-sm delete" data-id =" {{$disasterimage -> id}}"  type="submit">Delete</button>
                </form>
                <a href="{{ url('admin/disasterimage/'.$disasterimage->id)}}" title="View Disaster Image">

...
<div class="card push-top">
  ...
  <table class="table">
    <thead>
        ...
        <br>
        <div>        <a href="{{ url('user/disasterdamage/create') }}" class="btn btn-success btn-sm" title="Add New Disaster">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="text-center">
                ...
                <a href="{{ route('userdisasterdamage.edit', $disasterdamage->id)}}" class="btn btn-primary btn-sm">Edit</a>
                <form action="{{ route('userdisasterdamage.destroy', $disasterdamage->id)}}" method="post" style="display: inline-block">
                    @csrf
                    @method('DELETE')
                    <button class="btn btn-danger btn-sm" type="submit">Delete</button>
                </form>
                <div>
                <a href="{{ url('user/disasterdamage/'.$disasterdamage->id)}}" title="View Disaster Damage">
